...
function cssmenumaker_scripts_styles() {
    wp_enqueue_style( 'cssmenu-styles', get_template_directory_uri() . '/css/main.css');
    wp_enqueue_script('slick-settings', get_template_directory_uri() . '/js/libraries/slick.min.js');
    wp_enqueue_script('navbar', get_template_directory_uri() . '/js/navbar.js');
    wp_enqueue_script('partners-slider', get_template_directory_uri() . '/js/partners-slider.js');
}
